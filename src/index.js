...
module.exports.merge = function (oldConfig, vuxConfig) {
  ...
  try {
    ...
    let vuxPackagePath = path.resolve(require.resolve('vux/package.json'), '../..', 'vux/package.json')
    vuxVersion = require(vuxPackagePath).version
  } catch (e) {}
  ...
  try {
    ...
    let vuePackagePath = path.resolve(require.resolve('vux/package.json'), '../..', 'vue/package.json')
  ...
  try {
    ...
    let vueLoaderPackagePath = path.resolve(require.resolve('vux/package.json'), '../..', 'vue-loader/package.json')
  ...
  if (typeof isWebpack2 === 'undefined') {
    ...
    const pkg = require.resolve('vux/package.json')
  ...
  if (hasPlugin('vux-ui', vuxConfig.plugins)) {
    ...
    let mapPath = path.resolve(require.resolve('vux/package.json'), '..', 'src/components/map.json')
  ...
  if (hasPlugin('vux-ui', vuxConfig.plugins)) {
    ...
    let variablePath = path.resolve(require.resolve('vux/package.json'), '..', 'src/styles/variable.less')
    if (vuxConfig.options.vuxDev) {
  ...
  if (hasPlugin('vux-ui', vuxConfig.plugins)) {
    ...
    let vuxLocalesPath = path.resolve(require.resolve('vux/package.json'), '..', 'src/locales/all.yml')
    if (vuxConfig.options.vuxDev) {
